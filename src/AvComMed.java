public class AvComMed extends Aeronave implements Propulsor{
    public AvComMed(String codigo, String fechaentrega, String LG2A, int horastrabajoprev, int horastrabajoempleada, int capacidadpasajeros, double coste, double precioventa) {
