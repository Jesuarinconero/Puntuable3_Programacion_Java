public class avioneta extends Aeronave implements Propulsor {
    public avioneta(String codigo, String fechaentrega, String LG2A, int horastrabajo, int horastrabajoempleada, int capacidadpasajeros, double coste, double precioventa){
